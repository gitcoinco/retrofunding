...
export const Vote = () => {
  ...
  const availableMetricsIds = round?.roundMetadata.retroFundingConfig.impactMetrics;
  ...
  return (
    <div className="flex flex-col lg:flex-row lg:justify-center gap-12 px-20 pt-[52px]">
      <MetricsBallot
      ...
      />
      <VoteSidebar poolId={roundId} chainId={chainId} ballot={currentBallot} />
    </div>
  );
};
